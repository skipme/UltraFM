  ...
  var lastfm_state = {userName: null, key: null, isSubscriber: false,
    pushData: function(lastfmResponse){
        ...
        typeof lastfmResponse !== "undefined")
      {
        ...
        widgetPanel.port.emit("LastFMStatus", {isAuthorised: true, name: this.userName});
      }else{
    ...
    getData: function(){
      return {name: this.userName, key: this.key, subscriber: this.isSubscriber};
    }
  };
    ...
    lastfm_state.pushData(modelOpts.getLFMSession());
	}
